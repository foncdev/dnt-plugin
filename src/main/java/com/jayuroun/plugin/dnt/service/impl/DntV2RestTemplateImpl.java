...
public class DntV2RestTemplateImpl implements RestTemplate {

    private final String serverUrl;

    public DntV2RestTemplateImpl(String url) {
        this.serverUrl = url;
    }
    ...
    public Optional<DomainResponse> requestTranslate(Auth auth, int page, int limit, String projectName, String lang, String search) {
        ...
        WebTarget webTarget = createWebTarget(serverUrl + "/v2/domain")
        ...
        return Optional.of(response.readEntity(DntV2Response.class));
    }
    ...
    public Optional<DntModyResponse> requestModify(Auth auth, String project, String domain, String lang, String code,
        ...
        Response response = createWebTarget(serverUrl + "/v2/domain")
                ...
                .put(Entity.json(requestBody), Response.class);
    ...
    public Optional<DntV2ModyResponse> requestModifyV2(Auth auth, String project, String domain, String lang, String code, String dataType, String description) {
        ...
        return Optional.of(response.readEntity(DntV2ModyResponse.class));
    }
}
